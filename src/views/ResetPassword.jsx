...
export default function ResetPassword() {
  ...
  const onSubmit = async (ev) => {
    ...
    if (password_Ref.current.value != confirm_Ref.current.value) {
      Swal.fire({
        icon: "error",
      ...
      try {
        ...
        const response = await axiosClient.post('/password/reset', payload);
            ...
            <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <nav>
                <ol className="flex items-center gap-2">
                  <li>
                    <a className="font-medium" href="index.html"></a>
                  </li>
